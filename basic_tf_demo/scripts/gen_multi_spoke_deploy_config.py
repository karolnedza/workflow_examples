...
def main():
    ...
    parser.add_argument('--network-domain', required=True)
    parser.add_argument('--transit-gw-name', required=True)

    log.info("Parsing arguments")

    args = parser.parse_args()
    log.debug("Arguments: %s", pformat(args))
    ...
    log.info("Commit message: %s", commit_msg)
